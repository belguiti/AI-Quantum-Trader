  ...
  template: `
    <aside 
      ...
      <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-1">
        ...
        <a routerLink="/active-strategies" routerLinkActive="bg-primary/10 text-primary border-r-2 border-primary"
           (click)="close.emit()"
           class="flex items-center px-3 py-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition-all group">
          <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <a routerLink="/ai-signals" routerLinkActive="bg-primary/10 text-primary border-r-2 border-primary"
           (click)="close.emit()"
           class="flex items-center px-3 py-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition-all group">
          <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="px-3 mt-8 mb-2 text-xs font-semibold text-red-500 uppercase tracking-wider">Administration</div>

        <a routerLink="/admin" routerLinkActive="bg-red-900/20 text-red-500 border-r-2 border-red-500"
           (click)="close.emit()"
           class="flex items-center px-3 py-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition-all group">
           <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
